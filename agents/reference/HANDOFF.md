...
> 框架规范（`agents/AGENTS.md` 22 条铁律）回答「怎么做才算数」。两者冲突时**停下上报人类**，不要自行取舍。
>
> ⚠️ **一处需要人类裁决的重叠**：本文第 8 节「CONSTITUTION 九条铁律」与框架的
> `agents/CONSTITUTION.md`（项目加严层）职责相同。**同一件事有两个事实源迟早对不上**。
> 建议把第 8 节挪进 `agents/CONSTITUTION.md` §1，本文改为引用。**在人类裁决前，以本文第 8 节为准。**
...
## 8. CONSTITUTION —— 九条铁律（arbiter 判案依据，逐条执行）
